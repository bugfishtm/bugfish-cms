      ...
      <ul class="navbar-nav align-items-center">
        ...
        <li class="nav-item dropdown ms-lg-3">
		  ...
		  <?php foreach($lang_ar as $key => $value) { ?>	
            <a class="dropdown-item d-flex align-items-center" href="<?php echo hive__url(array(_HIVE_URL_CUR_[0], _HIVE_URL_CUR_[1], _HIVE_URL_CUR_[2])); ?>&hive__change_lang=<?php echo htmlspecialchars($value["ident"]); ?>">
