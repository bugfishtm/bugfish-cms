<?php
	/* 	 _           ___ _     _   _____ _____ _____ 
		...
		File Description:
			Windmill Theme Functionalitites.
			...
			?>
				  ...
				  <li class="flex">
					<a
					  ...
					  onclick = "window.location.href= '<?php echo hive__url(array(_HIVE_URL_CUR_[0], _HIVE_URL_CUR_[1], _HIVE_URL_CUR_[2])); ?><?php echo @$tmp_uri_theme; ?>'"
					>
						...
						<?php foreach($lang_ar as $key => $value) { ?>	
							<li class="flex">
							  <a
								...
								href="<?php echo hive__url(array(_HIVE_URL_CUR_[0], _HIVE_URL_CUR_[1], _HIVE_URL_CUR_[2])); ?>&hive__change_lang=<?php echo htmlspecialchars($value["ident"]); ?>"
							  >
