	...
	*/ if(!is_array($object)) { @http_response_code(404); Header("Location: ../"); exit(); }	
		$object["mysql"]->multi_query("
			CREATE TABLE IF NOT EXISTS `"._HIVE_PREFIX_."token` (
			  ...
			  `site_mode` varchar(26) NOT NULL COMMENT 'Related Site Module to be Refered To',
			  `token_key` varchar(255) NOT NULL COMMENT 'Token Key',
			  ...
			  UNIQUE KEY `hive__token_unique` (`token_key`));
		");