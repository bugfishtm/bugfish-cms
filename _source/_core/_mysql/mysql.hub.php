<?php
	...
	*/ if(!is_array($object)) { @http_response_code(404); Header("Location: ../"); exit(); }	
		$object["mysql"]->multi_query("
			CREATE TABLE IF NOT EXISTS `"._HIVE_PREFIX_."hub` (
				`id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'ID',
			    `fk_user` int(11) DEFAULT NULL COMMENT 'ID of User who created this item',
			    `mod_type` int(9) DEFAULT NULL COMMENT '1 - Game | 2 - Software | 3 - Scripts', 
			  ...
			  UNIQUE KEY `hive__hub_unique` (`mod_version`, `mod_build`, `mod_rname`));
		");