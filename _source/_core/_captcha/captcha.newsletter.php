<?php
	/* 	 _           ___ _     _   _____ _____ _____ 
		...
		File Description:
			...
			be adjusted by your site modules config.php setup. Code will be stored in $_SESSION[_HIVE_SITE_COOKIE_."captcha.newsletter"].
	*/
	...
	x_captcha(_HIVE_SITE_COOKIE_."captcha.newsletter", _CAPTCHA_WIDTH_, _CAPTCHA_HEIGHT_, _CAPTCHA_LINES_, _CAPTCHA_SQUARES_, _CAPTCHA_COLORS_, $font_path, _CAPTCHA_CODE_);
